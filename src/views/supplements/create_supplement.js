...
const options = {
  fields: {
    name: {
      ...
      help: "Whatever you call your supplement or medication name. If your mates are noisy and go through your phone (losers), name it Waffles. And then get new friends.",
      autoCapitalize: "none"
    }
  },
